...
CONFIG.DEFAULTHASH = /#10\/15.10461[\d]*\/108.08455[\d]*\/&base=std&ls=std&disp=1/g;
...
CONFIG.layerBaseFolder = "Bản đồ cơ sở";
...
CONFIG.baseMapDescription = {
  "std": "Bản đồ cơ sở.",
  "pale": "Bản đồ màu nhạt.",
  "blank": "Một bản đồ chỉ hiển thị đường bờ biển và ranh giới của các quận và thành phố.",
  "english": "English annotation map",
  "ort": "<div class=\"gsi_layerinfo_subtitle\"></div><a target=\"_blank\" href=\"https://sxdquangngai.gsi.go.jp/legend/seamlessphoto.pdf\"></a><div class=\"gsi_layerinfo_copy\"></div>"
}


CONFIG.HANREILIST = {
  "gsjGeomap_seamless200k_v2": {
    "url": "https://sxdquangngai/seamless/v2/api/1.2.1/legend.json",
    "layer": {
      "url": "https://sxdquangngai/seamless/v2/api/1.2/tiles/{z}/{y}/{x}.png",
      "minZoom": 3,
      "maxZoom": 13
    }
  },
  "vlcd_meakan": {
    "url": "https://sxdquangngai/xyz/vlcd_meakan/vlcd_meakan.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_meakan/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_tokachi": {
    "url": "https://sxdquangngai/xyz/vlcd_tokachi/vlcd_tokachi.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_tokachi/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_tarumae": {
    "url": "https://sxdquangngai/xyz/vlcd_tarumae/vlcd_tarumae.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_tarumae/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_usu": {
    "url": "https://sxdquangngai/xyz/vlcd_usu/vlcd_usu.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_usu/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_hokoma": {
    "url": "https://sxdquangngai/xyz/vlcd_hokoma/vlcd_hokoma.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_hokoma/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_iwate": {
    "url": "https://sxdquangngai/xyz/vlcd_iwate/vlcd_iwate.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_iwate/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_akitakoma": {
    "url": "https://sxdquangngai/xyz/vlcd_akitakoma/vlcd_akitakoma.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_akitakoma/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_chokai": {
    "url": "https://sxdquangngai/xyz/vlcd_chokai/vlcd_chokai.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_chokai/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_kurikoma": {
    "url": "https://sxdquangngai/xyz/vlcd_kurikoma/vlcd_kurikoma.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_kurikoma/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  ...
  "vlcd_bandai": {
    "url": "https://sxdquangngai/xyz/vlcd_bandai/vlcd_bandai.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_bandai/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_kusatsu": {
    "url": "https://sxdquangngai/xyz/vlcd_kusatsu/vlcd_kusatsu.csv",
    "layer": {
      "url": "https://sxdquangngaixyz/vlcd_kusatsu/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_asamayama": {
    "url": "https://sxdquangngai/xyz/vlcd_asamayama/vlcd_asamayama.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_asamayama/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_niigatayake": {
    "url": "https://sxdquangngai/xyz/vlcd_niigatayake/vlcd_niigatayake.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_niigatayake/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_ontake": {
    "url": "https://sxdquangngai/xyz/vlcd_ontake/vlcd_ontake.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_ontake/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_fuji": {
    "url": "https://sxdquangngai/xyz/vlcd_fuji/vlcd_fuji.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_fuji/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_hakone": {
    "url": "https://sxdquangngai/xyz/vlcd_hakone/vlcd_hakone.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_hakone/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_izuo": {
    "url": "https://sxdquangngai/xyz/vlcd_izuo/vlcd_izuo.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_izuo/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_miyake": {
    "url": "https://sxdquangngai/xyz/vlcd_miyake/vlcd_miyake.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_miyake/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_hachijojima": {
    "url": "https://sxdquangngai/xyz/vlcd_hachijojima/vlcd_hachijojima.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_hachijojima/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_kuju": {
    "url": "https://sxdquangngai/xyz/vlcd_kuju/vlcd_kuju.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_kuju/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_aso": {
    "url": "https://sxdquangngai/xyz/vlcd_aso/vlcd_aso.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_aso/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_unzen": {
    "url": "https://sxdquangngai/xyz/vlcd_unzen/vlcd_unzen.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_unzen/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_kiri": {
    "url": "https://sxdquangngai/xyz/vlcd_kiri/vlcd_kiri.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_kiri/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_sakura": {
    "url": "https://sxdquangngai/xyz/vlcd_sakura/vlcd_sakura.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_sakura/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_satsumaio": {
    "url": "https://sxdquangngai/xyz/vlcd_satsumaio/vlcd_satsumaio.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_satsumaio/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_satsumatake": {
    "url": "https://sxdquangngai/xyz/vlcd_satsumatake/vlcd_satsumatake.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_satsumatake/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_suwanosejima": {
    "url": "https://sxdquangngai/xyz/vlcd_suwanosejima/vlcd_suwanosejima.csv",
    "layer": {
      "url": "https://sxdquangngaixyz/vlcd_suwanosejima/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "vlcd_akitayake": {
    "url": "https://sxdquangngai/xyz/vlcd_akitayake/vlcd_akitayake.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/vlcd_akitayake/{z}/{x}/{y}.png",
      "minZoom": 10,
      "maxZoom": 16
    }
  },
  "swale": {
    "url": "https://sxdquangngai/xyz/swale/swale.csv",
    "layer": {
      "url": "https://sxdquangngai/xyz/swale/{z}/{x}/{y}.png",
      "minZoom": 5,
      "maxZoom": 16
    }
  }
...
CONFIG.layerEvacuationFolder = "Khu vực sơ tán khẩn cấp được chỉ định";
CONFIG.layerEvacuationFolderSYS = "GSI.MAP.EVAC";
CONFIG.layerEvacuationHeader = "skhb";
CONFIG.layerEvacuationIsConfirmOK = false;

CONFIG.DisasterLoreFolder = "Đài tưởng niệm thiên tai";
...
CONFIG.VolcanoTerrainFolder = "Dữ liệu phân loại địa hình núi lửa";
...
// 初期位置
CONFIG.DEFAULT = { CENTER: [15.015759, 108.715210], ZOOM: 10 };

// Danh sách loại lớp
CONFIG.LAYERTYPELIST = {
  "kml": { caption: "KML", isTile: false },
  "tile": { caption: "Thùng rác...", isTile: true, isTileImage: true },
  "geojson": { caption: "GeoJSON", isTile: false },
  "topojson": { caption: "TopoJSON", isTile: false },
  "geojson_tile": { caption: "gạch GeoJSON", isTile: true },
  "topojson_tile": { caption: "Ngói JSON Topo", isTile: true },
  "tms": { caption: "TMS", isTile: true, isTileImage: true },
  "multiLayer": { caption: "nhiều lớp", isTile: false },
...
CONFIG.HELPMENU = [
  ...
  { 'Moji': 'Zalo', 'Img': './image/help/logo-transperant-2048x1943.png', 'Link': 'https://chat.zalo.me/ ' },
...
CONFIG.LAYERTREESEARCHLIST = [
   ...
   "Bản đồ chuyên đề",
   "Điểm kiểm soát/Quan sát trắc địa",
   "Liên quan đến thiên tai (động đất, bão, mưa lớn, núi lửa)",
   "Thông tin từ các tổ chức khác",
   "Thí nghiệm cung cấp gạch vector",
   "Bản đồ cơ sở",
   "cập nhật thông tin",
